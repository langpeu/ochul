...
- 공용 패드에서 선생님 계정을 전환할 수 있도록 앱 내 로그아웃을 제공한다.
...
Flutter 앱용 Secrets 파일에는 Supabase URL과 anon/publishable key만 넣고, service role/secret key는 Supabase Edge Function secret에만 둡니다.
